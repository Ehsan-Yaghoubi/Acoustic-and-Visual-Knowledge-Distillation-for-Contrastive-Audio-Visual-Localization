...
def get_arguments():
    ...
    parser.add_argument('--experiment_name', type=str, default='vggsound_10k_rebuttal_run', help='experiment name (used for checkpointing and logging)')
    ...
    parser.add_argument('--train_data_path', default='/data2/datasets/vggsound/', type=str, help='Root directory path of train data')
    #parser.add_argument('--test_data_path', default='/data2/datasets/vggss/vggss_labeled/', type=str, help='Root directory path of test data')
